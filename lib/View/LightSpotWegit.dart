...
class LightSpotWegit extends StatefulWidget {
  LightSpotWegit({Key? key}) : super(key: key);

  @override
  _LightSpotWegit createState() => _LightSpotWegit();
}

class _LightSpotWegit extends State<LightSpotWegit>
